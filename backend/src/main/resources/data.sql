...
-- Users
INSERT INTO user_profile (id,user_type) VALUES (1000,'TRADER'), (1001,'SUPPORT'),(1002,'ADMIN');
INSERT INTO application_user (id, first_name, last_name, login_id, password, active, user_profile_id, version, last_modified_timestamp) VALUES
  (1000, 'Alice', 'Smith', 'alice', 'password', true, 1000, 1, '2025-06-02T00:00:00'),
  (1001, 'Bob', 'Jones', 'bob', 'password', true, 1001, 1, '2025-06-02T00:00:00');
INSERT INTO privilege (id, name) VALUES (1000, 'ADMIN'), (1001, 'TRADER');

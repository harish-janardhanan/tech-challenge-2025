...
public class TradeControllerTest {
    ...
    void setUp() {
        ...
        tradeDTO.setTradeDate(LocalDateTime.now());
        tradeDTO.setStartDate(LocalDateTime.now().plusDays(2));
        tradeDTO.setMaturityDate(LocalDateTime.now().plusYears(5));
        ...
        trade.setStartDate(LocalDateTime.now().plusDays(2));
    ...
    void testGetAllTrades() throws Exception {
        ...
        List<TradeDTO> tradeDTOs = Arrays.asList(tradeDTO);
    ...
    void testCreateTradeValidationFailure_MissingBook() throws Exception {
        // Given
        TradeDTO invalidDTO = new TradeDTO();
        invalidDTO.setTradeDate(LocalDateTime.now());
        invalidDTO.setCounterpartyName("TestCounterparty");

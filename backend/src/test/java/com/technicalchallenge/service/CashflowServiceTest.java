...
public class CashflowServiceTest {
    ...
    void testSaveCashflowWithInvalidPaymentValue() {
        ...
        invalidCashflow.setLeg(tradeLeg);
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            cashflowService.saveCashflow(invalidCashflow);
        });
